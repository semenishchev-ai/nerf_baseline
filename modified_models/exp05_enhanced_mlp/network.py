"""
EXP-05: Enhanced MLP Decoder with Residual Connections
Wider MLP (128 neurons), GELU activation, skip connections, larger geo_feat_dim.
Source: General residual learning trend (He et al., CVPR 2016);
NGP-RT lightweight attention (arXiv 2024) — no official code for NGP.
"""
import torch
