"""
EXP-13_2: Active Learning / Boundary-Aware Sampling (Option C)
Guides the sampler to focus on object boundaries by looking at the total transmittance (weights_sum).
Rays that are "partially translucent" are prioritized for refinement.
"""
import torch
