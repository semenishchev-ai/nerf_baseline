...
Adds a learnable global "density shift" parameter that adapts to the scene's transparency.
Rationale: Helps in handling semi-transparent regions and "thin" structures 
(like the Lego crane strings).
"""
import torch
...
class NeRFNetwork(NeRFRenderer):
    def __init__(self,
        ...
        # === MODIFICATION: Learnable Density Shift ===
    ...
    def forward(self, x, d):
        ...
        # Apply density shift before trunc_exp
        sigma = trunc_exp(h[..., 0] + self.density_shift)
        geo_feat = h[..., 1:]
    ...
    def get_params(self, lr):
        params = [
            ...
            {'params': [self.density_shift], 'lr': lr}, 
